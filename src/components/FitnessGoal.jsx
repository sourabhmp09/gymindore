...
const FitnessGoal = () => {
  ...
  <div className="container">
    <div className="row gx-0 align-items-center">
      <div
        className="col-md-5 col-lg-6 aos-init aos-animate"
        data-aos="fade-right"
      ...
      <div className="col-md-7 col-lg-6">
        <div className="fitness_col4">
          ...
          >
            <p>
              Ditch the excuses, grab your motivation backpack! "Get Ready To
              Reach Your Fitness Goals" isn't just a title, it's a battle cry.
              This guide is your personal trainer, cheerleader, and
              goal-crushing buddy rolled into one. We'll break down your
              aspirations into bite-sized.
            </p>
            <p>
              Get ready to conquer your doubts, rewrite your limits, and finally
              claim the healthier, happier you!
            </p>
          </div>
          <button
